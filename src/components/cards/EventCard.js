            ...
            <div>
                <a href="#" className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500">
                        ...
                        professionals from across the renewable energy domain.
                        REI is recognized as Asia’s Leading b2b expo focusing on
                        Solar Energy, Wind Energy, Bio-Energy, Energy Storage
                        and Electric Vehicles and charging infra.
                    </p>
                </a>
            </div>
        </div>
