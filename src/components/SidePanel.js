              ...
              <li>
                <details>
                  ...
                  <ul className="menu dropdown-content z-[1] bg-base-100">
                    <Link href="/businesses/create" onClick={handleLinkClick}>
                      {" "}
                      <li>
              ...
              <li>
                <details>
                  <summary className="hover:text-inherit text-inherit">
                    ...
                    <span className="mary-hideable">My Associations</span>
                  </summary>
                  <ul className="menu dropdown-content z-[1] bg-base-100">
                    <li>
                      <Link
              ...
              <li>
                <details>
                  <summary>
                    ...
                    <span className="mary-hideable">Help and Support</span>
                  </summary>
